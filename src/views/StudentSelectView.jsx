(function () {
  function StudentSelectView({
    ...
    return (
      <div className="container">
        <div className="card">
          {/* Cabeçalho flexível com o botão de regresso ao painel */}
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
            <div>
              <h2 style={{ margin: 0 }}>🤓 Quem vai jogar hoje?</h2>
              <p className="subtitle" style={{ margin: '4px 0 0 0' }}>
                Escolhe o teu ano e depois o teu nome na lista da turma.
              </p>
            </div>
  ...
  window.StudentSelectView = StudentSelectView;
})();